...
const cards = [
  ...
  },
  {
    ...
    desc: "Notre moteur analyse plus de 6 000 avis et des centaines de combinaisons pour construire votre routine idéale, étape par étape, adaptée à votre signature capillaire.",
    span: "lg:col-span-5",
    bg: "bg-kisiir-dark",
    text: "text-white",
